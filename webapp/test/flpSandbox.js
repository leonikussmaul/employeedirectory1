		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#employeedirectory1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeedirectory1-display": {
								"semanticObject": "employeedirectory1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeedirectory1",
									"url": sap.ui.require.toUrl("employeedirectory1")
								}
							}
						}
					}
